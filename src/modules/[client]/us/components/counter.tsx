  ...
  return (
    <Content>
      <div className="py-32 flex-col-center gap-16 md:flex-row ">
        <div className="flex-col-center rounded shadow--primary text-primary-500 p-4 w-[300px] h-[400px]">
          <img
          ...
          <div className="grid text-center">
            <span
              className="counter font-bold text-primary-500 text-[64px]"
              data-target="100"
            ></span>
        ...
        <div className="flex-col-center rounded shadow--primary text-primary-500 py-4 w-[300px] h-[400px]">
          <img
