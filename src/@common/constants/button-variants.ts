...
export const buttonIconVariants = cva(
  'rounded flex-center text-nowrap font-medium outline-none focus:ring',
  {
    variants: {
      variant: variants,
      size: {
        xs: 'h-[1.5rem] w-[1.5rem] text-xs font-medium md:h-[1.75rem] md:w-[1.75rem]',
        sm: 'h-[2rem] w-[2rem] sm:h-[2.25rem] sm:w-[2.25rem]',
        md: 'h-[2.5rem] w-[2.5rem] sm:h-[2.75rem] sm:w-[2.75rem]',
        lg: 'h-[3rem] w-[3rem] sm:h-[3.25rem] sm:w-[3.25rem]'
      }
    },
    defaultVariants: {
      variant: 'primary',
